...
import com.emeraldhieu.testcontainers.product.logic.sort.InvalidSortOrderException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    static final URI PROBLEM_TYPE_URI = URI.create("http://localhost:50001/testcontainers/types");
